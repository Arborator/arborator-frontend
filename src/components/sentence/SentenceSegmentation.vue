            ...
            <div class="col">
              ...
              <div class="custom-frame2" style="overflow: auto">
                <VueDepTree
                  ...
                  :reactive-sentence="(firstReactiveSentence[userId] as any)"
                  :reactive-sentences-obj="(firstReactiveSentence as any)"
                  :diff-mode="'NO_DIFF'"
                  :sentence-bus="sentenceBus"
                  :tree-user-id="userId"
                  :has-pending-changes="hasPendingChanges"
            ...
            <div class="col">
              ...
              <div class="custom-frame2" style="overflow: auto">
                <VueDepTree
                  ...
                  :reactive-sentence="(secondReactiveSentence[userId] as any)"
                  :reactive-sentences-obj="(secondReactiveSentence as any)"
                  :diff-mode="'NO_DIFF'"
                  :sentence-bus="sentenceBus"
                  :tree-user-id="userId"
                  :has-pending-changes="hasPendingChanges"
        ...
        <div v-if="showResults">
          ...
          <div style="overflow: auto" class="custom-frame2">
            <VueDepTree
              ...
              :reactive-sentence="(mergedReactiveSentence[userId] as any)"
              :reactive-sentences-obj="(mergedReactiveSentence as any)"
              :diff-mode="'NO_DIFF'"
              :sentence-bus="sentenceBus"
              :tree-user-id="userId"
              :has-pending-changes="hasPendingChanges"
