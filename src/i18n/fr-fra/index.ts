export default {
  ...
  error404: "Cette ressource n'existe pas dans le backend ArboratorGrew",
  ...
  invalidChar: 'Caractère non autorisé',
  ...
  homepage: {
    ...
    textGetUserEmailDialog: [
      ...
      'Vous pouvez modifier ou supprimer votre adresse email de contact à tout moment depuis votre compte.',
    ],
    checkboxEmailDialog: [
  ...
  projectView: {
    ...
    synchronizedWith: 'Synchronisé avec',
    settings: 'Paramètres',
  ...
  grewSearch: {
    ...
    occ: '{count} occurrence',
    occ_plural: '{count} occurrences',
    sent: '{count} phrase',
    sent_plural: '{count} phrases',
    node: '{count} nœud',
    node_plural: '{count} nœuds',
    edge: '{count} relation',
    edge_plural: '{count} relation',
  ...
  projectSettings: {
    ...
    configProject: 'La configuration du projet',
    configProjectCaption: 'La configuration du projet',
    configProjectSelect: 'Selectionner la configuration du projet', 
    shownFeaturesPanel: 'Traits affichés',
  ...
  github: {
    ...
    branchAlreadyExists: 'Cette branche existe déjà ! Veuillez choisir un autre nom.',
    ...
    statusLabel: 'status',
    statusNotif: ['Vous avez ', 'fichier modifié', 'fichiers modifiés', "Votre branche locale est propre"],
    ...
    concurrentModificationsWarning: 'ArboratorGrew ne gère pas les modifications concurrentes. Si vous prévoyez de modifier vos données à partir d\'ArboratorGrew et d\'une autre manière dans GitHub, veuillez gérer vous-même la synchronisation. Si deux modifications concurrentes sur l\'échantillon se produisent, une poussée depuis ArboratorGrew effacera la modification GitHub ; une extraction depuis ArboratorGrew effacera la modification ArboratorGrew. Si vous devez gérer les modifications concurrentes, utilisez une branche git spécifique pour l\'interaction avec ArboratorGrew.',
    statusDialog: {
      title: 'status',
      selection: '{selected} sélectionné(s) sur {total}',
      selectAll: 'Tout sélectionner',
      clearSelection: 'Tout désélectionner',
      showChanges: 'Voir le diff',
  ...
  attributeTable: {
    ...
    eraseFeature: "Supprimer l'attribut",
  ...
  constructicon: {
    ...
    uploadFileLabel: 'Choisir un fichier',
    ...
    deleteBtn: 'Supprimer',
    search: 'Rechercher',
    deleteSuccess: 'Entrée "{title}" supprimée',
    deleteError: 'Erreur lors de la suppression de l’entrée du constructicon',
    loadError: 'Erreur lors du chargement des entrées du constructicon',
  ...
  sentenceSegmentation: {
    ...
    proposedMetadata: 'Métadonnées proposées',
    showResultBtn: 'Afficher les résultats',
  },
  grewHistory: {
