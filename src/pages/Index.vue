        ...
        <q-card flat class="fixed-center">
          ...
          <q-card-actions align="around">
            <q-btn
              ...
              color="primary"
              no-caps
              >{{ $t("homepage.accessTreebankBtn") }}</q-btn
            >
          </q-card-actions>
          ...
          <q-card-section>
            <q-carousel
              ...
              height="200px"
              :class="
                $q.dark.isActive ? 'bg-grey-10 text-white' : 'text-blue-grey-8'
              "
          ...
          <q-card-actions align="around" vertical>
            <span class="text-center text-caption text-grey">{{
              $t("homepage.scroll")
            }}</span>
      ...
      <q-card flat class="q-pa-md q-gutter-y-xl">
        ...
        <section class="row items-start">
          <q-card flat class="col-md-4">
            ...
            <q-card-section>
              <a
                href="http://www.lrec-conf.org/proceedings/lrec2020/pdf/2020.lrec-1.651.pdf"
                target="_blank"
              >
                Gaël Guibon, Marine Courtin, Kim Gerdes, Bruno Guillaume. When
                Collaborative Treebank Curation Meets Graph Grammars: Arborator
                With a Grew Back-End Actes de LREC 2020.</a
              >
              <q-space />
              ...
              >
              <q-card
                class="clickable text-caption clickhl"
                flat
                bordered
                @click="copy()"
              >
                @InProceedings{guibon-EtAl:2020:LREC, author = {Guibon, Gaël and
                Courtin, Marine and Gerdes, Kim and Guillaume, Bruno}, title =
                {When Collaborative Treebank Curation Meets Graph Grammars},
                booktitle = {Proceedings of The 12th Language Resources and
                Evaluation Conference}, month = {May}, year = {2020}, address =
                {Marseille, France}, publisher = {European Language Resources
                Association}, pages = {5293--5302}, url =
                {https://www.aclweb.org/anthology/2020.lrec-1.651} }
                <q-tooltip
                  content-class="bg-accent"
                  content-style="font-size: 12px"
                >
          ...
          <q-card flat class="col-md-4">
            ...
            <q-card-section>
              ...
              <q-btn
                type="a"
                href="https://github.com/Arborator"
                target="_blank"
                icon="fab fa-github"
                flat
                round
              ...
              <a
                ...
                target="_blank"
                >{{ $t("homepage.sourceCard.content[3]") }}</a
