...
export default {
  ...
  parser: {
    ...
    pretrainModelHint: 'Optional; We will use this model as a pretrain model for your task',
    trainSettings: 'Train settings',
    trainOnAllfiles: 'Train on All files',
    filesToParse: 'Files to parse',
    customUser: 'Custom Training user',
    trainingUser: 'Training user',
    parseSettings: 'Parse settings',
    parseAllFiles: 'Parse all files',
