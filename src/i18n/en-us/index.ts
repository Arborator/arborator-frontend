export default {
  ...
  grewSearch: {
    ...
    allTree: 'all trees',
    baseTree: 'base trees',
    otherTree: 'trees of a specific user',
    search: 'Search',
    rewrite: 'Rewrite',
    tryRules: 'Try rules',
    ...
    sent: '{count} sentence',
    sent_plural: '{count} sentences',
    node: '{count} node',
    node_plural: '{count} nodes',
    edge: '{count} relation',
    edge_plural: '{count} relations',
    user: '{count} user',
  ...
  projectSettings: {
    ...
    configProject: 'Corpus configuration',
    configProjectCaption: 'The project configuration is: ',
    configProjectSelect: 'Select the configuration', 
