...
export default {
  ...
  error403:
    "Hey you! You do not have the permissions for this action. Please contact the administrator.",
  ...
  homepage: {
    ...
    descriptionCard: {
      ...
      subtitle:
        "An easy to use graphic annotation interface makes it annotation the best part of a linguist's day.",
      content: [
  ...
  projectSettings: {
    ...
    chooseUserDiffCaption: "user that will be use as reference for the comparaison",
