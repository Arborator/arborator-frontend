<template>
  <q-dialog v-model="tableConlluDialogOpened" style="backdrop-filter: blur(4px)">
              ...
              <q-td key="FORM" :props="props">
                ...
                >
                  <q-input 
                    ...
                    @keyup.enter="validateAndSave('FORM', scope.value, scope)" 
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="LEMMA" :props="props">
                ...
                >
                  <q-input 
                    ...
                    @keyup.enter="validateAndSave('LEMMA', scope.value, scope)"
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="UPOS" :props="props">
                ...
                >
                  <q-input
                    ...
                    dense
                    autofocus
                    @keyup.enter="validateAndSave('UPOS', scope.value, scope)"
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="XPOS">
              ...
              <q-td key="FEATS" :props="props">
                ...
                >
                  <q-input
                    ...
                    dense
                    autofocus
                    @keyup.enter="validateAndSave('FEATS', scope.value, scope)"
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="HEAD" :props="props">
                ...
                >
                  <q-input
                    ...
                    dense
                    autofocus
                    @keyup.enter="validateAndSave('HEAD', scope.value, scope)"
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="DEPREL" :props="props">
                ...
                >
                  <q-input
                    ...
                    dense
                    autofocus
                    @keyup.enter="validateAndSave('DEPREL', scope.value, scope)"
                  />
                </q-popup-edit>
              </q-td>
              <q-td key="DEPS">
...
export default defineComponent({
  components: { TokensReplaceDialog },
  props: {
    sentenceBus: {
  ...
  mounted() {
    this.sentenceBus.on('open:tableConlluDialog', ({ userId }) => {
      this.userId = userId;
      this.tableConlluDialogOpened = true;
      this.getConllTable();
    });
  ...
  methods: {
    ...
    onConllDialogOk() {
      ...
      if (this.sentenceBus.sentenceSVGs[this.userId].exportConll() !== this.conllContent) {
    ...
    validateAndSave(fieldName: string, value: any, scope: any) {
      const checkMethods: { [key: string]: (val: any) => boolean } = {
        'FORM': this.checkForm,
        'LEMMA': this.checkLemma,
        'UPOS': this.checkUPOS,
        'FEATS': this.checkFEATS,
        'HEAD': this.checkHEAD,
        'DEPREL': this.checkDEPREL,
      };

      const checkFn = checkMethods[fieldName];
      if (!checkFn) return;
      ...
      if (checkFn(value)) {
        ...
        notifyMessage({
          message: this.formatErrorTable[fieldName].message,
          type: 'negative',
          icon: 'error',
        });
      }
